...
var RequestNew = function (_Component) {
  ...
  (0, _createClass3.default)(RequestNew, [{
    ...
    value: function render() {
      ...
      })), _react2.default.createElement(_semanticUiReact.Button, { primary: true, loading: this.state.loading }, 'Create!'), _react2.default.createElement(_semanticUiReact.Message, {
        error: true,
        header: 'Oops!',
